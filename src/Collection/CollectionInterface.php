...
interface CollectionInterface extends Iterator, JsonSerializable
{
     ...
     *
     * @param iterable $elements Items list.
     * @return self
     */
     ...
     *
     * @param mixed $element The item to append.
     ...
     *
     * @param mixed $elements The items to prepend.
     * @return self
     */
     ...
     *
     * @param mixed $element The item to prepend.
     ...
     * ```
     *
     * @param iterable ...$elements The collections to zip.
     * @return self
     */
